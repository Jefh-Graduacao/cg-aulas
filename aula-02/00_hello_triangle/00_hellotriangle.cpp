...
#include <GLFW/glfw3.h> // windows --> opengl
#include <iostream>
...
int main()
{
	...
	GLFWwindow* g_window = glfwCreateWindow(800, 600, "Hello Triangle VIZLAB", NULL, NULL);
	if (!g_window)
	{
		glfwTerminate();
		return -1;
	...
	// Define a janela como o 'contexto' da OpenGL
	...
	// Array com os vértices do triângulo
	GLfloat points[] =
	{
		0.0f, 0.5f, 0.0f,  // V0
		0.5f, -0.5f, 0.0f, // V1
	...
	// Array com as cores de cada vértice
	GLfloat colours[] = 
	{ 
		1.0f, 0.0f, 0.0f, // C0
		0.0f, 1.0f, 0.0f, // C1
	...
	GLuint points_vbo;
	// Inicializa o buffer dos vértices
	glGenBuffers(1, &points_vbo);
	// Define que as próximas chamadas usarão o buffer com id 'points_vbo'
	glBindBuffer(GL_ARRAY_BUFFER, points_vbo);
	// Insere os dados no buffer
	glBufferData(GL_ARRAY_BUFFER, 9 * sizeof(GLfloat), points, GL_STATIC_DRAW);

	GLuint colours_vbo;
	// Inicializa o buffer das cores
	glGenBuffers(1, &colours_vbo);
	// Define que as próximas chamadas usarão o buffer com id 'colours_vbo'
