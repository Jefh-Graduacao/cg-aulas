...
int main1()
{
	...
	// Array com os vertices do triangulo
	GLfloat points[] =
	{
		0.0f, 0.5f, 0.0f,  // V0
		0.5f, -0.5f, 0.0f, // V1
	...
	// Array com as cores de cada vertice
	GLfloat colours[] =
	{
		1.0f, 0.0f, 0.0f, // C0
		0.0f, 1.0f, 0.0f, // C1
	...
	// Define que as proximas chamadas usarao o buffer com id 'points_vbo'
	...
	// Define que as proximas chamadas usarao o buffer com id 'colours_vbo'
